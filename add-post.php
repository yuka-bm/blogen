...
<body>
    ...
    <div class="container text-center mt-5 w-50">
        <form action="#" method="POST">
            ...
            <select name="category" id="category" class="form-select border-1 border-dark border-top-0 border-start-0 border-end-0 rounded-0 mt-4" required>
            ...
            <div class="input-group mt-4">
                ...
                <select name="author" id="author" class="form-select border-1 border-dark border-top-0 border-start-0 border-end-0 rounded-0" required>
                    <option value="" hidden>Select Author</option>
                    <?php
                        $categories = getAllAuthors();
                        while ($category = $categories->fetch_assoc()) {
                            echo "<option value=" . $category['account_id'] . ">" . $category['username'] . "</option>";
                        }
                    ?>
                </select>
            </div>
